...
return [
    ...
    */
    ...
    'prohibited_if_accepted' => 'El campo :attribute está prohibido cuando :other se acepta.',
    'prohibited_if_declined' => 'El campo :attribute está prohibido cuando :other se rechaza.',
    ...
    | Esto nos permite especificar rápidamente un mensaje específico.
    |
    */
    ...
    | posición de atributos por algo más legible, como "Dirección de correo"
    | en lugar de "email". Esto simplemente nos ayuda a que el mensaje sea
    | más expresivo.
    |
    */
